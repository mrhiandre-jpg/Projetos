...
class View_Professor():
    def __init__(self, mestre, cursor, conn):
        ...
        self.sub_abas = ctk.CTkTabview(self.mestre)
        self.sub_abas.pack(fill="both", expand=True)

        self.sub_abas.add('Contratar')
        self.sub_abas.add('Demitir')
    ...
    def contratar_professor(self):
        contr_prof = self.sub_abas.tab('Contratar')

        self.digt_nome_prof = ctk.CTkEntry(contr_prof,
                                           placeholder_text='Digite o nome do Professor',
                                           width=300
                                           )
        self.digt_nome_prof.pack(pady=20)

        self.digt_material_prof = ctk.CTkEntry(contr_prof ,
                                               placeholder_text='Digite o Material do Professor',
                                               width=300
                                               )
        self.digt_material_prof.pack(pady=20)

        self.btn_salvar_prof = ctk.CTkButton(contr_prof,
                                             text="Contratar",
